      ...
      const { customSafelistExtractor, generateSafelist } = require("/home/projects/sb1-mtt2pnml/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "/home/projects/sb1-mtt2pnml/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/home/projects/sb1-mtt2pnml/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
